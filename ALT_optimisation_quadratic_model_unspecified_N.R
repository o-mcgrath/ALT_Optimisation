##############################################################################
### Test plan optimisation for Weibull quadratic AFT model (Unspecified N) ###
##############################################################################
...
objective_function <- function(x, n_sim = 1000, test_units = 100, 
                               ...
                               pquant = 0.5, model_params = c(13, -38, 18, 2), 
...
ALT_optimise <- function(n_sim = 1000, test_units = 100, 
                         test_duration = 1*24*365, min_units = 1, 
                         min_stress_levels = 3, max_stress_levels = 6, 
                         stress_distance = 10^(-5), min_stress = 0.1, 
                         max_stress = 0.9, design_stress = 0.05,   
                         p_cens_limit = 0.8, filter_limit = 0.95,  
                         pquant = 0.5, model_params = c(13, -38, 18, 2), dp = 5,
...
n_sim <- 1000 
#Minimum number of stress levels (design points) (must be >= 3)
min_stress_levels <- 3
